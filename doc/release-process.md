...
### Build and sign Dash Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit allgamescoin=v${VERSION} ../allgamescoin/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Release on Dash forum: https://www.allgamescoin.org/forum/topic/official-announcements.54/
