...
testScripts = [
    ...
    'spentindex.py',
    'decodescript.py',
    'p2p-fullblocktest.py', # NOTE: needs allgamescoin_hash to pass
    'blockchain.py',
    'disablewallet.py',
    'sendheaders.py', # NOTE: needs allgamescoin_hash to pass
    'keypool.py',
    'keypool-hd.py',
    'prioritise_transaction.py',
    'invalidblockrequest.py', # NOTE: needs allgamescoin_hash to pass
    'invalidtxrequest.py', # NOTE: needs allgamescoin_hash to pass
    'abandonconflict.py',
...
testScriptsExt = [
    'bip9-softforks.py',
    'bip65-cltv.py',
    'bip65-cltv-p2p.py', # NOTE: needs allgamescoin_hash to pass
    'bip68-sequence.py',
