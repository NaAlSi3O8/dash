...
#ifndef ALLGAMESCOIN_TEST_SCRIPTNUM10_H
#define ALLGAMESCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AllGamesCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ALLGAMESCOIN_TEST_BIGNUM_H
