Bitcoin version 0.7.1 is now available from:
  http://sourceforge.net/projects/allgamescoin/files/Bitcoin/allgamescoin-0.7.1/
...
* Clicking on a allgamescoin: URI on Windows should now launch Bitcoin-Qt properly.
