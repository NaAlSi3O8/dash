...
This document describes the protocol extensions for all additional functionality build into the AllGamesCoin protocol. This doesn't include any of the AllGamesCoin protocol, which has been left intact in the AllGamesCoin project. For more information about the core protocol, please see https://en.allgamescoin.it/w/index.php?title#Protocol_documentation&action#edit
...
AllGamesCoin Outpoint https://allgamescoin.org/en/glossary/outpoint
...
AllGamesCoin Input https://allgamescoin.org/en/glossary/input
...
AllGamesCoin Output https://allgamescoin.org/en/glossary/output
...
AllGamesCoin Public Key https://allgamescoin.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 1000 ALLGAMESCOIN
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 ALLGAMESCOIN unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 allgamescoin)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the allgamescoin treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 ALLGAMESCOIN for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 ALLGAMESCOIN for masternode 2
