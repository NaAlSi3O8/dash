Allgamescoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/allgamescoin/files/Allgamescoin/allgamescoin-0.5.4/
...
http://gitorious.org/allgamescoin/allgamescoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Allgamescoin-Qt notifications under Growl 1.3.
Increase required age of Allgamescoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAllgamescoin properly when installing Allgamescoin-Qt over it. (Windows)
