    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ALLGAMESCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("ALLGAMESCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ALLGAMESCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ALLGAMESCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ALLGAMESCOIN-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new AllgamescoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->allgamescoinAtStartup, OptionsModel::StartAtStartup);
