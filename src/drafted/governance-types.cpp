...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AllgamescoinNetwork") type = AllgamescoinNetwork;
    if(strType == "AllgamescoinNetworkVariable") type = AllgamescoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AllgamescoinNetwork) s = "AllgamescoinNetwork";
    if(type == AllgamescoinNetworkVariable) s = "AllgamescoinNetworkVariable";
