...
AllGamesCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- AllGamesCoinMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as AllGamesCoin Core, where everyone uses
...
pay attention to for reviewers of AllGamesCoin Core code.

General AllGamesCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: AllGamesCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
