Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/allgamescoin/files/Bitcoin/allgamescoin-0.7.0/

We recommend that everybody running prior versions of allgamescoind/Bitcoin-Qt
