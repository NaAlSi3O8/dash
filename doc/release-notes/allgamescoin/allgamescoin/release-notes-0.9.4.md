Allgamescoin Core version 0.9.4 is now available from:

  https://allgamescoin.org/bin/0.9.4/
...
this update is incompatible with the Allgamescoin system and could lead to consensus
forks.

Allgamescoin Core released binaries from https://allgamescoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~allgamescoin/+archive/ubuntu/allgamescoin
- A third-party or self-compiled Allgamescoin Core

upgrade to Allgamescoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
