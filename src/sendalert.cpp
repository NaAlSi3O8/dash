...
2. run allgamescoind with -printalert or -sendalert like this:
   /path/to/allgamescoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.allgamescoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/AllGamesCoin Core:0.12.0.58/"));
