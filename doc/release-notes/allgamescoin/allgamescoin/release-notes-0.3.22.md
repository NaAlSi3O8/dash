Download URL: https://sourceforge.net/projects/allgamescoin/files/Allgamescoin/allgamescoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 AGC fee schedule (users still pay 0.01 AGC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #allgamescoin00 - #allgamescoin99
