#ifndef ALLGAMESCOIN_CHAINPARAMSSEEDS_H
#define ALLGAMESCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the allgamescoin network
...
#endif // ALLGAMESCOIN_CHAINPARAMSSEEDS_H
