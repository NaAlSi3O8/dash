...
unlocked to sign the AllGamesCoin-Qt.app bundle.
...
allowing somebody to distribute a AllGamesCoin-Qt.app or allgamescoin-qt-setup.exe with a valid
...
that the allgamescoin-qt.exe file inside the installer had not been tampered with.
