    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("AllGamesCoin") + " - ";
#ifdef ENABLE_WALLET
    ...
    QPixmap pixmapLogo(":/images/light/allgamescoin_logo_horizontal");
...
void AllGamesCoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and allgamescoin: URIs)"));
    ...
    aboutAction = new QAction(tr("&About AllGamesCoin"), this);
    aboutAction->setStatusTip(tr("Show information about AllGamesCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AllGamesCoin"));
    ...
    openAction->setStatusTip(tr("Open a allgamescoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AllGamesCoin help message to get a list with possible AllGamesCoin command-line options"));
...
void AllGamesCoinGUI::createToolBars(QWidget* statusbar)
{
    if(walletFrame)
    {
...
void AllGamesCoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("AllGamesCoin client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("AllGamesCoin"); // default title
