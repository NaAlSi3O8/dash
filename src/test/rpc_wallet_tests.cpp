// Copyright (c) 2013-2015 The Allgamescoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAllgamescoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAllgamescoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CAllgamescoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAllgamescoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAllgamescoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAllgamescoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
