...
This mechanism has been integrated into Bitcore-Node-Allgamescoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/allgamescoindev/insight-api-allgamescoin#web-socket-api](https://github.com/allgamescoindev/insight-api-allgamescoin#web-socket-api)
* API: [https://github.com/allgamescoindev/insight-api-allgamescoin#instantsend-transactions](https://github.com/allgamescoindev/insight-api-allgamescoin#instantsend-transactions)
...
By default, the Allgamescoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Allgamescoin Core daemon:
