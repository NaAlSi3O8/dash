Allgamescoin Core version 0.9.2.1 is now available from:

  https://allgamescoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AGC to 0.01 AGC
...
- Fix "Start allgamescoin on system login"
