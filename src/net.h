...
#ifndef ALLGAMESCOIN_NET_H
#define ALLGAMESCOIN_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in AllGamesCoin,
    // because it's used in many AllGamesCoin-specific places (masternode, privatesend).
