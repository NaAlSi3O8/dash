Allgamescoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/allgamescoin/files/Allgamescoin/allgamescoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Allgamescoin
...
New/changed settings (command-line or allgamescoin.conf file)
--------------------------------------------------------
