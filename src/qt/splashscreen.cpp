    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextAllGamesCoin   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The AllGamesCoin developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextAllGamesCoin);
