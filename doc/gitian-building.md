...
git clone https://github.com/allgamescoindev/dash
```
...
```bash
    ...
    From https://github.com/allgamescoindev/dash
...
[dash/gitian.sigs](https://github.com/allgamescoindev/gitian.sigs/) repository, or if that's not possible to create a pull
request.
