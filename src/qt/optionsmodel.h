...
#ifndef ALLGAMESCOIN_QT_OPTIONSMODEL_H
#define ALLGAMESCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Allgamescoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // AllgamescoinUnits::Unit
...
#endif // ALLGAMESCOIN_QT_OPTIONSMODEL_H
