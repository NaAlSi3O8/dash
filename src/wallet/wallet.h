...
#ifndef ALLGAMESCOIN_WALLET_WALLET_H
#define ALLGAMESCOIN_WALLET_WALLET_H
...
public:
    ...
    /// Get 1000ALLGAMESCOIN output and keys which can be used for the Masternode
...
#endif // ALLGAMESCOIN_WALLET_WALLET_H
