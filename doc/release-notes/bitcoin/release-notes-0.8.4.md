Allgamescoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/allgamescoin/files/Allgamescoin/allgamescoin-0.8.4/
...
code, causing the Allgamescoin-Qt or allgamescoind process to crash.
...
their own version of Allgamescoin against Boost versions 1.50-1.52.
