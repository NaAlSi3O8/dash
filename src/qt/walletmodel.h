...
#ifndef ALLGAMESCOIN_QT_WALLETMODEL_H
#define ALLGAMESCOIN_QT_WALLETMODEL_H
...
/** Interface to AllGamesCoin wallet from Qt view code. */
...
#endif // ALLGAMESCOIN_QT_WALLETMODEL_H
